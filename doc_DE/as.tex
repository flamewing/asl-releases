...
{\em G"ultigkeit: AVR, M*Core, ST9, 80C16x, KCPSM ({\tt NAMEREG} nur
 f"ur KCPSM(3)), LatticeMico8, MSP430}
...
%%-----------
\begin{quote}
bc) 370C010, 370C020, 370C030, 370C040 und 370C050
\end{quote}
...
{\em G"ultigkeit: 680x0, 68xx, M*Core, XA, H8, SH7000, TMS9900, MSP430, ST7}
...
umschaltet.  Dies ist in erste Linie für Befehle wichtig, die implizit eines
...
mitteilen, daß die folgenden Befehle mit diesem ge"anderten Mapping arbeiten.  Der
Assembler wird für Befehle, in denen die Registernummer explizit kodiert ist, dann
...
drei und beim 320C3x/C4x sogar derer 4 (MSB zuerst).  Im Gegensatz dazu mu"s
...
bedeutet, da"s \tty{DATA} beim 320C3x/C4x die Funktion von \tty{WORD} mit
...
Toshiba hat seinerzeit für diesen Prozessor einen (DOS-basierten)
Assembler namens ASM31T geliefert.  Dieser Assembler unterstützt
...
\item{Wie ASM31T unterst"utzt AS für den TC9331 Kommentare in
