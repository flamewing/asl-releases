...
\begin{verbatim}
      ENUMCONF 1,CODE
\end{verbatim}  
bestimmen, daß sie im Instruktions-Adre"sraum liegen sollen.  Die
...
\input{taborg5.tex}
\hline
\multicolumn{10}{|l|}{$^{*}$ Bereich für Programmcode auf 1 MByte
begrenzt} \\
\hline
\end{tabular}\end{center}
...
Siemens speziell für Telefone entwickelte Variante, die ebenfalls
...
Vergleich zu den AT90...-Vorg"angern auch neue Maschinenbefehle mit.
%%-----------
\begin{quote}
...
dem allerdings nur das erste MByte für Programmcode genutzt
...
\errentry{1504}{Z80-Syntax nicht erlaubt}
               ...
               {Dieser Befehl ist nur erlaubt, wenn die
                Z80-Syntax für 8080/8085-Befehle freigeschaltet
                wurde.}
               {keines}
