...
\hline
            ...
            & (Intel,     & (Rockwell,     &  (PowerPC,  & (Panafacom) \\
            & Zilog,      &  Motorola,     &   AMD29K,   & \\
            & Thomson,    &  Microchip,    &   National, & \\
            & Texas,      & Thomson,       &   Symbios,  & \\
            & Toshiba,    & Hitachi)       &   Atmel)    & \\
            & NEC,        &                &             & \\
            & Siemens,    &                &             & \\
            & Philips,    &                &             & \\
            & Fujitsu,    &                &             & \\
...
bin"ar      & Suffix B        & Pr"afix \% & Pr"afix 0b & O'..' \\
oktal       & Suffix O oder Q & Pr"afix @  & Pr"afix 0  & B'..' \\
\hline
\end{tabular}\end{center}
...
kann (auf Kosten der Kompatibilit"at zu Standard-Assemblern). Insbesondere
er"offnet sich mit dieser Option die 'IBM-Schreibweise', wie man sie bei manchen
Fremdassemblern antrifft, f"ur alle Ziele:
...
{\em G"ultigkeit: 8080/8085/8086, XA, Z80, Z8000, 320C2x/5x, TLCS-47, AVR, F8}
...
%%-----------
\begin{quote}
ch) PMC150, PMS150, PFS154, PMC131, PMS130, PMS131 \\
...
%%-----------
\begin{quote}
ci) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A, 1805A
1806A
\end{quote}
...
{\em G"ultigkeit: PIC, MELPS-4500, HMCS400, 3201x, 320C2(0)x,\\
     320C5x, AVR, $\mu$PD772x, OLMS-40/50, Padauk}
...
Ulf Meinke, Matthias Paul, Norbert Rosch, Curt J. Sampson,
