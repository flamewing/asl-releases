...
\end{quote}
TI's Model 990 Computer besitzt ein Flag, um im privilegierten Modus
zu arbeiten.  Einige Instruktionen k"onnen nur in diesem Modus
ausgef"uhrt werden und f"uhren im nicht-privilegierten Modus zu einer
Exception.  Der TMS99xx haben keinen solchen Modus, die fraglichen
Instruktionen werden immer ausgef"uhrt.  TMS9995 und TMS99105 f"ugen dem
TMS9900 Befehlssatz ein paar Instruktionen hinzu, w"ahrend der
TMS9940 einige entfernt und daf"ur andere hinzuf"ugt.
%%-----------
\begin{quote}
\begin{tabbing}
\hspace{0.7cm} \= \kill
