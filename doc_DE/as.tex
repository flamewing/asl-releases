...
%%-----------
\begin{quote}
n) 6502 $\rightarrow$ 65(S)C02 / MELPS740
\end{quote}
...
Intel 8080/8085 angelehnt - das gilt auch für die Mnemonics.  Die
Adressierungsart (direkt, indirekt, immediate) ist mit in das
Mnemonic verpackt, und 16-Bit-Register (BC, DE, HL) werden wie
beim 8080 mit einem Buchstaben abgekürzt.  Da NEC in der
...
auch in der Form schreiben, wie sie Zilog für den Z80 definiert hat. 
...
\par
Falls \tty{PAGE} auf dem gewählten Target bereits ein
