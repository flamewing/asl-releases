...
{\em G"ultigkeit: PowerPC, M-Core, 4004/4040, 80C16x, AVR, XS1, Z8}
...
%%-----------
\begin{quote}
bd) TMS1000, TMS1100, TMS1200, TMS1300
\end{quote}
...
%%-----------
\begin{quote}
bh) COP410 $\rightarrow$ COP420 $\rightarrow$ COP440 $\rightarrow$ COP444
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
bi) \> SC14400, SC14401, SC14402, SC14404, SC14405, \\
...
\begin{quote}
\begin{tabbing}
bq) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
auﬂer bei der Definition des Makros wurde die
...
mit 4-Bit-Adressen angesprochen werden kˆnnen.  Welcher 16er-Block
...
muﬂ.  Man kann diese Funktion auch dazu benutzen, Arbeitsregistern
...
mˆglich, eine Adressierung mit 8 Bit zu erzwingen, auch wenn die
...
kompatibel zum alten Z8-Kern zu sein, hat Zilog die zus‰tzlichen
...
Zum einen ist der Befehlssatz dieser Controller teilweise ¸ber die ROM-Maske
...
Des weiteren ist zu beachten, daﬂ Spr"unge und Unterprogrammaufrufe nur die
...
\errentry{ 310}{Ung"ultiger Wert f"ur Registerzeiger}
               {Warnung}
               {G"ultige bzw. sinnvolle Werte f¸r den Registerzeiger sind
...
\errentry{ 320}{Makro-Argument umdefiniert}
               ...
               {Einem Makroparameter wurden zwei oder mehr
                ...
                Verwendung von Schl¸sselwortparametern auftreten.
