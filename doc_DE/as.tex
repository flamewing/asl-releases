...
\item{\tty{FPU}: erlaubt bzw. sperrt die Befehle des numerischen Koprozessors
      ...
      auch der FPU-Typ (\tty{NS32081} oder \tty{NS32381}) angegeben werden,
      um die erweiterten Register und Befehle freizugeben oder zu verbieten.}
