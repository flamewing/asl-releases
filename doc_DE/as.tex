...
\item{Motorola 6800, 6805, 68HC(S)08, 6809, 68(HC)11(K4) sowie Hitachi 6301}
...
%%-----------
\begin{quote}
s) 8021, 8022, 8039, 80C39, 8048, 80C48, 8041, 8042
\end{quote}
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
t) \> 87C750 $\rightarrow$ 8051, 8052, 80C320, 80C501, 80C502, \\
...
%%-----------
\begin{quote}
u) 8096 $\rightarrow$ 80196 $\rightarrow$ 80196N $\rightarrow$ 80296
\end{quote}
...
%%-----------
\begin{quote}
v) 8080 $\rightarrow$ 8085 $\rightarrow$ 8085UNDOC
\end{quote}
...
%%-----------
\begin{quote}
w) 8086 $\rightarrow$ 80186 $\rightarrow$ V30 $\rightarrow$ V35
\end{quote}
...
%%-----------
\begin{quote}
aa) AT90S1200 $\rightarrow$ AT90S2313 $\rightarrow$ AT90S4414 $\rightarrow$
...
%%-----------
\begin{quote}
ab) AM29245 $\rightarrow$ AM29243 $\rightarrow$ AM29240 $\rightarrow$ AM29000
\end{quote}
...
%%-----------
\begin{quote}
ac) 80C166 $\longrightarrow$ 80C167,80C165,80C163
\end{quote}
...
%%-----------
\begin{quote}
ad) Z80 $\rightarrow$ Z80UNDOC $\rightarrow$ Z180 $\rightarrow$ Z380
\end{quote}
...
%%-----------
\begin{quote}
ae) Z8601, Z8604, Z8608, Z8630, Z8631 $\rightarrow$ eZ8
\end{quote}
...
%%-----------
\begin{quote}
ak) 47C00 $\rightarrow$ 470C00 $\rightarrow$ 470AC00
\end{quote}
...
%%-----------
\begin{quote}
am) 16C54 $\rightarrow$ 16C55 $\rightarrow$ 16C56 $\rightarrow$ 16C57
\end{quote}
...
%%-----------
\begin{quote}
ap) ST6210/ST6215 $\rightarrow$ ST6220/ST6225
\end{quote}
...
%%-----------
\begin{quote}
ar) ST9020, ST9030, ST9040, ST9050
\end{quote}
...
%%-----------
\begin{quote}
au) 320C25 $\rightarrow$ 320C26 $\rightarrow$ 320C28
\end{quote}
...
%%-----------
\begin{quote}
aw) 320C203 $\rightarrow$ 320C50, 320C51, 320C53
\end{quote}
...
%%-----------
\begin{quote}
ba) 370C010, 370C020, 370C030, 370C040 und 370C050
\end{quote}
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
bg) \> SC14400, SC14401, SC14402, SC14404, SC14405, \\
...
\begin{quote}
\begin{tabbing}
bn) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
\item{Version 1.42:
      ...
      \item{unterst"utzt zus"atzlich die COP4-Familie von National
            Semiconductor;}
      \item{unterst"utzt zus"atzlich die HCS08-Erweterungen von Freescale;}
      \end{itemize}}
\end{itemize}
