...
{\tt\begin{tabbing}
\hspace{3cm}\=\hspace{3cm}\=\hspace{3cm}\=\hspace{3cm}\=\kill
ADR        \> BYT         \> DC[.$<$size$>$] \> DEFBIT  \> DEFBITFIELD \\
DFS        \> DS[.$<$size$>$] \> FCB         \> FCC     \> FDB         \\
PADDING     \> RMB \\
\end{tabbing}}
...
{\tt\begin{tabbing}
\hspace{3cm}\=\hspace{3cm}\=\hspace{3cm}\=\hspace{3cm}\=\kill
DC[.$<$size$>$] \> DS[.$<$size$>$] \> MAXMODE     \> PADDING \> REG \\
\end{tabbing}}

\subsubsection{Hitachi H8/500}
{\tt\begin{tabbing}
\hspace{3cm}\=\hspace{3cm}\=\hspace{3cm}\=\hspace{3cm}\=\kill
ASSUME          \> DATA   \> DC[.$<$size$>$] \> DS[.$<$size$>$] \> MAXMODE \\
PADDING         \> REG \\
\end{tabbing}}
