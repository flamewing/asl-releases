...
static tNLSCharacterTab const Tab8859_1 = {
        {'\344', '\0'}, /* eCH_ae */
        {'\353', '\0'}, /* eCH_ee */
        {'\357', '\0'}, /* eCH_ie */
        {'\366', '\0'}, /* eCH_oe */
...
static tNLSCharacterTab const Tab437 = {
        {'\204', '\0'}, /* eCH_ae */
        {'\211', '\0'}, /* eCH_ee */
        {'\213', '\0'}, /* eCH_ie */
        {'\224', '\0'}, /* eCH_oe */
...
static tNLSCharacterTab const Tab850 = {
        {'\204', '\0'}, /* eCH_ae */
        {'\211', '\0'}, /* eCH_ee */
        {'\213', '\0'}, /* eCH_ie */
        {'\224', '\0'}, /* eCH_oe */
...
static tNLSCharacterTab const TabUTF8 = {
        {'\303', '\244'}, /* eCH_ae 0xe4 */
        {'\303', '\253'}, /* eCH_ee 0xeb */
        {'\303', '\257'}, /* eCH_ie 0xef */
        {'\303', '\266'}, /* eCH_oe 0xf6 */
...
static tNLSCharacterTab const TabASCII7 = {
        { 'a',  'e'}, /* eCH_ae */
        { 'e',  'e'}, /* eCH_ee */
        { 'i',  'e'}, /* eCH_ie */
        { 'o',  'e'}, /* eCH_oe */
...
char const NLS_HtmlCharacterTab[eCH_cnt][9] = {
        "&auml;",   /* eCH_ae     */
        "&euml;",   /* eCH_ee     */
        "&iuml;",   /* eCH_ie     */
        "&ouml;",   /* eCH_oe     */
...
tNLSCharacterTab const* GetCharacterTab(tCodepage Codepage) {
    switch (Codepage) {
...
int CharTab_GetLength(tNLSCharacterTab const* pTab, tNLSCharacter Character) {
    if (!(*pTab)[Character][0]) {
        return 0;
...
char const* CharTab_GetNULTermString(
        tNLSCharacterTab const* pTab, tNLSCharacter Character, char* pBuffer) {
