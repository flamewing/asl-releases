...
[![CI Windows MinGW](https://img.shields.io/github/actions/workflow/status/flamewing/asl-releases/ci-windows-mingw.yml?label=CI%20Windows&logo=Windows&logoColor=white)](https://github.com/flamewing/asl-releases/actions/workflows/ci-windows-mingw.yml?query=workflow%3Aci-windows-mingw)
[![CI Windows MSVC](https://img.shields.io/github/actions/workflow/status/flamewing/asl-releases/ci-windows-msvc.yml?label=CI%20Windows&logo=Windows&logoColor=white)](https://github.com/flamewing/asl-releases/actions/workflows/ci-windows-msvc.yml?query=workflow%3Aci-windows-msvc)
