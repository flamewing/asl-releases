...
static void AddLit(char const* NName, Word NCode) {
    AddInstTable(InstTable, NName, NCode, DecodeLit);
}

static void AddAri(char const* NName, Word NCode, Word NDef) {
...
static void AddF(char const* NName, Word NCode) {
