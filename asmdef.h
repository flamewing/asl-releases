...
extern char SrcSuffix[], IncSuffix[], PrgSuffix[], LstSuffix[], MacSuffix[], PreSuffix[],
        LogSuffix[], MapSuffix[], OBJSuffix[];
...
typedef Boolean (*tQualifyQuoteFnc)(char const* pStart, char const* pQuotePos);
...
typedef struct tag_TSaveState {
    ...
    tLstMacroExpMod        SaveLstMacroExpModDefault, SaveLstMacroExpModOverride;
...
extern ASSUMERec const* pASSUMERecs;
...
extern char const* DivideChars;
extern Boolean     HasAttrs;
extern char const* AttrChars;
...
extern char const*   PCSymbol;
extern tIntConstMode IntConstMode;
extern Boolean       IntConstModeIBMNoTerm;
extern Boolean (*SetIsOccupiedFnc)(void), (*SaveIsOccupiedFnc)(void),
...
extern char         MomCPUIdent[20], MomFPUIdent[20], MomPMMUIdent[20];

extern Boolean FPUAvail, PMMUAvail; /* PMMU-Befehle erlaubt? */
extern Boolean DoPadding, TargetBigEndian;
...
extern char const* pCommentLeadIn;
