...
void as_nonz_dynstr_ini_c_str(as_nonz_dynstr_t* p_str, char const* p_src) {
...
void as_nonz_dynstr_realloc(as_nonz_dynstr_t* p_str, size_t new_capacity) {
    ...
    char*  p_new_str    = p_str->p_str ? (char*)realloc(p_str->p_str, new_capacity)
...
size_t as_nonz_dynstr_to_c_str(
...
size_t as_nonz_dynstr_copy(as_nonz_dynstr_t* p_dest, as_nonz_dynstr_t const* p_src) {
    size_t trans_len;
...
size_t as_nonz_dynstr_append_raw(
        as_nonz_dynstr_t* p_dest, char const* p_src, int src_len) {
    size_t trans_len;
...
size_t as_nonz_dynstr_copy_c_str(as_nonz_dynstr_t* p_dest, char const* p_src) {
    p_dest->len = 0;
...
size_t as_nonz_dynstr_append(as_nonz_dynstr_t* p_dest, as_nonz_dynstr_t const* p_src) {
...
int as_nonz_dynstr_cmp(as_nonz_dynstr_t const* p_str1, as_nonz_dynstr_t const* p_str2) {
...
void as_nonz_dynstr_dump_hex(FILE* p_file, as_nonz_dynstr_t const* p_str) {
    char const* p_run;
