...
void AddStringListFirst(StringList* List, char const* NewStr) {
    StringRecPtr Neu;
...
void AddStringListLast(StringList* List, char const* NewStr) {
...
void RemoveStringList(StringList* List, char const* OldStr) {
...
char const* GetStringListFirst(StringList List, StringRecPtr* Lauf) {
    *Lauf = List;
    if (!*Lauf) {
        return "";
    } else {
...
char const* GetStringListNext(StringRecPtr* Lauf) {
    if (!*Lauf) {
        return "";
    } else {
        char* tmp = (*Lauf)->Content;
