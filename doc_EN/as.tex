...
{\em valid for: 680x0, AVR, M*Core, ST9, 80C16x, KCPSM ({\tt NAMEREG} valid only
...
%%-----------
\begin{quote}
ap) 47C00 $\rightarrow$ 470C00 $\rightarrow$ 470AC00
\end{quote}
...
%%-----------
\begin{quote}
as) 16C54 $\rightarrow$ 16C55 $\rightarrow$ 16C56 $\rightarrow$ 16C57
\end{quote}
...
%%-----------
\begin{quote}
aw) ST6200, ST6201, ST6203, ST6208, ST6209,\\
...
%%-----------
\begin{quote}
ay) ST9020, ST9030, ST9040, ST9050
\end{quote}
...
%%-----------
\begin{quote}
bd) 320C203 $\rightarrow$ 320C50, 320C51, 320C53
\end{quote}
...
%%-----------
\begin{quote}
bh) 370C010, 370C020, 370C030, 370C040 and 370C050
\end{quote}
...
%%-----------
\begin{quote}
bj) TMS1000, TMS1100, TMS1200, TMS1300
\end{quote}
...
%%-----------
\begin{quote}
bn) COP410 $\rightarrow$ COP420 $\rightarrow$ COP440 $\rightarrow$ COP444
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
bo) \> SC14400, SC14401, SC14402, SC14404, SC14405, \\
...
%%-----------
\begin{quote}
bq) MK3870, MK3872, MK3873, MK3874, MK3875, MK3876, \\
    MK38C70
\end{quote}
...
\begin{quote}
\begin{tabbing}
ca) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
%%-----------
\begin{quote}
cd) MSM5840, MSM5842, MSM58421, MSM58422, MSM5847
\end{quote}
...
%%-----------
\begin{quote}
cg) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A,
1805A, 1806A
\end{quote}
...
{\em valid for: PIC, 320xx, AVR, MELPS-4500, H8/500 \\
     HMCS400, 4004/4040, $\mu$PD772x, OLMS-40/50}
