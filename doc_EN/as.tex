...
%%-----------
\begin{quote}
ai) Z8601, Z8604, Z8608, Z8630, Z8631 $\rightarrow$ eZ8
\end{quote}
...
%%-----------
\begin{quote}
be) TI990, TMS9900, TMS9940, TMS9995, TMS99105
\end{quote}
TI's Model 990 computer has a flag to operate in privileged mode.  Some
instructions may only be executed in this mode and result in an exception if
used in non-privileged mode. The TMS99xx do not have such a mode, the
instructions in question are always executed.  The TMS9995 and TMS99105 add a few
instructions to the TMS9900's instruction set, while the TMS9940 deletes
a few and adds different ones.
%%-----------
\begin{quote}
\begin{tabbing}
\hspace{0.7cm} \= \kill
...
%%-----------
\begin{quote}
ce) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A,
1805A, 1806A
\end{quote}
...
{\em valid for: 680x0, 68xx, M*Core, XA, H8, SH7000, MSP430(X), TMS9900, ST7/STM8}
...
\errentry{1447}{register bank mismatch}
               {error}
               {An address expression uses resgisters from different banks.}
               {the register in queszion}
