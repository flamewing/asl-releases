...
{\em valid for: PowerPC, M-Core, 4004/4040, 80C16x, AVR, XS1, Z8}
...
%%-----------
\begin{quote}
bg) COP410 $\rightarrow$ COP420 $\rightarrow$ COP440 $\rightarrow$ COP444
...
\begin{quote}
\begin{tabbing}
bp) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
valid for: \= Intel (except for 4004/4040), Zilog, Toshiba,\\
           ...
           \> M16(C), National, ST9, TMS70Cxx, Signetics,\\
           \> $\mu$PD77230, Fairchild, Intersil, XS1
\end{tabbing}}
...
Once again, the optional control parameters \tty{GLOBALSYMBOLS}
resp. \tty{NOGLOBALSYMBOLS} (marked as such by being enclosed in
curly braces) decide wheter labels are local to the individual
repetitions.
...
The function chain built up via \tty{AddCleanUpProc} works similar to
\tty{AddInitPassProc}: It enables code generators to do clean-ups after
