...
br) F3850, MK3870, MK3872, MK3873, MK3874, MK3875, \\
    MK3876, MK38C70
\end{quote}
The instruction set of all F8 variants is the same, except for the
CMOS version than knows two new instructions (HET and HAL).
Otherwise, they differ by the size of the address space (64K for
F3850, 4K for the rest), the amount of built-in memory (2 or
