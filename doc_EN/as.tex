...
\item{\tty{FPU}: allows or prohibits the commands of the numerical
      ...
      the explicit FPU type (\tty{NS32081} or \tty{NS32381}) is also possible,
      to enable or disable the additional registers and instructions.}
\item{\tty{PMMU}: allows or prohibits the commands of the memory
      ...
      statement. The status variable is called \tty{PMMUAVAIL}.}
\end{itemize}
