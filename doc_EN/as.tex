...
compatibility to standard assemblers).  This option specifically enabled
the 'IBM notation', a syntac that is sometimes found on other assemblers,
for all targets:
...
{\em valid for: 8080/8085/8086, XA, Z80, Z8000, 320C2x/5x, TLCS-47, AVR, F8}
...
%%-----------
\begin{quote}
ci) 1802 $\rightarrow$ 1804, 1805, 1806 $\rightarrow$ 1804A,
1805A, 1806A
\end{quote}
