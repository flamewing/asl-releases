...
REGAVR.INC        & register and bit addresses AVR family (current) \\
...
{\em valid for: 8080/8085/8086, XA, Z80, 320C2x/5x, TLCS-47, AVR, F8}
...
%%-----------
\begin{quote}
af) 80C166 $\rightarrow$ 80C167,80C165,80C163
\end{quote}
...
%%-----------
\begin{quote}
au) ST6210/ST6215$\rightarrow$ST6220/ST6225
\end{quote}
...
%%-----------
\begin{quote}
aw) ST9020, ST9030, ST9040, ST9050
\end{quote}
...
%%-----------
\begin{quote}
bb) 320C203 $\rightarrow$ 320C50, 320C51, 320C53
\end{quote}
...
%%-----------
\begin{quote}
bf) 370C010, 370C020, 370C030, 370C040 and 370C050
\end{quote}
...
%%-----------
\begin{quote}
bh) TMS1000, TMS1100, TMS1200, TMS1300
\end{quote}
...
%%-----------
\begin{quote}
bl) COP410 $\rightarrow$ COP420 $\rightarrow$ COP440 $\rightarrow$ COP444
...
\begin{tabbing}
\hspace{0.7cm} \= \kill
bm) \> SC14400, SC14401, SC14402, SC14404, SC14405, \\
...
%%-----------
\begin{quote}
bo) MK3870, MK3872, MK3873, MK3874, MK3875, MK3876, \\
    MK38C70
\end{quote}
...
\begin{quote}
\begin{tabbing}
by) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
%%-----------
\begin{quote}
cb) MSM5840, MSM5842, MSM58421, MSM58422, MSM5847
\end{quote}
...
{\em valid for: PIC, 320xx, AVR, MELPS-4500, HMCS400,\\
     4004/4040, $\mu$PD772x, OLMS-40/50}
