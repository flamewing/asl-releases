...
%%-----------
\begin{quote}
be) 370C010, 370C020, 370C030, 370C040 and 370C050
\end{quote}
...
%%-----------
\begin{quote}
bn) MK3870, MK3872, MK3873, MK3874, MK3875, MK3876, \\
    MK38C70
\end{quote}
...
\begin{quote}
\begin{tabbing}
bx) \= SYM53C810, SYM53C860, SYM53C815, SYM53C825, \\
    \> SYM53C875, SYM53C895
\end{tabbing}
\end{quote}
...
%%-----------
\begin{quote}
bz) MSM5840, MSM5842, MSM58421, MSM58422, MSM5847
\end{quote}
...
will automatically use the shortest possible encoding for a given
displacement.  It is however possible to enforce a 16-bit coding by
prefixing the displacement argument with a bigger sign ((\verb!>!).
similar is true for absolute addresses in the area from 0ff80h to
0ffffh, which may be reached via a short offset relative to the 
"null register".
