...
\errentry{2180}{invalid bit field}
               {error}
               {the bit field does not conform to the required syntax {\tt (start,count)} syntax.}
               {the argument in question}
